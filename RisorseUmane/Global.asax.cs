...
namespace RisorseUmane
{
    public class Global : HttpApplication
    {
        ...
        protected void Application_BeginRequest(object sender, EventArgs e)
        {
            ...
            {
                context.Items["DBContext"] = new MappingDataContext(System.Configuration.ConfigurationManager.ConnectionStrings["RisorseUmaneDBConnectionString"].ConnectionString);
            }
        }
