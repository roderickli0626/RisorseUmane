...
{
    public partial class Malattia : System.Web.UI.Page
    {
        User user;
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            int? requestID = ParseUtil.TryParseInt(HfMalattiaID.Value);

            bool success = new RequestController().SaveMalattiaRequest(requestID, senderID, sdate, edate, description);
            if (success)
            {
