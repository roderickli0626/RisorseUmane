<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="Malattia.aspx.cs" Inherits="RisorseUmane.Malattia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="HfMalattiaID" runat="server" ClientIDMode="Static" />
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-12" style="min-height: 100vh;">
                <div class="bg-secondary rounded h-100 p-5">
                    <h1 class="mb-4 text-center">MALATTIA</h1>
                    <div class="mt-5 row">
                        <div class="col-md-4">
                            <button class="btn btn-lg btn-primary w-100 mb-2 btn-add">+ AGG. MALATTIA</button>
                        </div>
                        <div class="col-md-4">
                    ...
                    <table class="table table-striped text-center mt-4" id="malattia-table">
                        <thead>
                            <tr>
                                <th scope="col">Nr</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content bg-secondary">
                <div class="modal-header">
                    <h4 class="modal-title text-white" id="modalTitle">Malattia</h4>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterPlaceHolder" runat="server">
    ...
    <script>
        $("#TxtSearch").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: 'DataService.asmx/FindAllMalattias',
                    dataType: "json",
    ...
    <script>
        ...
        var datatable = $('#malattia-table').dataTable({
            "serverSide": true,
            "ajax": 'DataService.asmx/FindMalattias',
            ...
            "rowCallback": function (row, data, index) {
                ...
                $("#malattia-table_wrapper").css('width', '100%');
            }
        });
        ...
        datatable.on('click', '.btn-edit', function (e) {
            ...
            $("#MalattiaModal").modal('show');
            $(".modal-title").text("AGGIORNA MALATTIA");
            $("#HfMalattiaID").val(row.Id);
            $("#ValSummary").addClass("d-none");
        ...
        datatable.on('click', '.btn-delete', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: 'DataService.asmx/DeleteMalattia',
                data: {
                    id: row.Id
                },
                success: function () {
